...
# Install Nginx
RUN apt update && apt install --no-install-recommends -y nginx && apt-get clean && rm -rf /var/lib/apt/lists/* && apt-get update && apt-get upgrade libdb5.3 && apt-get upgrade zlib1g
